# Copyright (c) 2024-2025 BensRaider Inc.
# This project is licensed under the BensRaider License, which includes additional
...
class Render:
    ...
    def render_ascii(self):
        self.clear()
        self.title(f"BensRaider | Connected as {os.getlogin()} | made by Tips-Discord")
        edges = ["╗", "║", "╚", "╝", "═", "╔"]
        ascii = f"""
{'██████╗ ███████╗███╗   ██╗███████╗██████╗  █████╗ ██╗██████╗ ███████╗██████╗ '.center(self.size)}
{'██╔══██╗██╔════╝████╗  ██║██╔════╝██╔══██╗██╔══██╗██║██╔══██╗██╔════╝██╔══██╗'.center(self.size)}
...
class Menu:
    ...
    @wrapper
    def dm_spam(self):
        console.title(f"BensRaider - Dm Spammer")
    ...
    @wrapper
    def soundbord(self):
        console.title(f"BensRaider - Soundboard Spam")
    ...
    @wrapper
    def friender(self):
        console.title(f"BensRaider - Friender")
    ...
    @wrapper
    def caller(self):
        console.title(f"BensRaider - Call Spammer")
        user_id = input(console.prompt("User ID"))
        if user_id == "":
            self.main_menu()
    ...
    def onliner(self):
        console.title(f"BensRaider - Onliner")
        args = [
    ...
    @wrapper
    def typier(self):
        console.title(f"BensRaider - Typer")
    ...
    def nick_changer(self):
        console.title(f"BensRaider - Nickname Changer")
    ...
    def voice_joiner(self):
        console.title(f"BensRaider - Voice Joiner")
        Link = input(console.prompt("Channel LINK"))
        if Link == "" or not Link.startswith("https://"):
            self.main_menu()
    ...
    def Thread_Spammer(self):
        console.title(f"BensRaider - Thread Spammer")
        Link = input(console.prompt("Channel LINK"))
        if Link == "" or not Link.startswith("https://"):
            self.main_menu()
    ...
    @wrapper
    def joiner(self):
        console.title(f"BensRaider - Joiner")
    ...
    @wrapper 
    def leaver(self):
        console.title(f"BensRaider - Leaver")
        guild = input(console.prompt("Guild ID"))
        if guild == "":
            self.main_menu()
    ...
    @wrapper
    def spammer(self):
        console.title(f"BensRaider - Spammer")
        link = input(console.prompt(f"Channel LINK"))
        if link == "" or not link.startswith("https://"):
            self.main_menu()
    ...
    def checker(self):
        console.title(f"BensRaider - Checker")
        self.raider.token_checker()

    @wrapper
    def reactor(self):
        console.title(f"BensRaider - Reactor")
    ...
    def button(self):
        console.title(f"BensRaider - Button Click")
        Link = input(console.prompt("Message Link"))
        if Link == "" or not Link.startswith("https://"):
            self.main_menu()
            return
    ...
    def formatter(self):
        console.title(f"BensRaider - Formatter")
        self.run(self.raider.format_tokens, [()])

    @wrapper
    def accept(self):
        console.title(f"BensRaider - Accept Rules")
    ...
    @wrapper
    def guild(self):
        console.title(f"BensRaider - Guild Checker")
        guild_id = input(console.prompt("Guild ID"))
        if guild_id == "":
            self.main_menu()
    ...
    def bio_changer(self):
        console.title(f"BensRaider - Bio Changer")
    ...
    @wrapper
    def onboard(self):
        console.title(f"BensRaider - Onboarding Bypass")
        guild_id = input(console.prompt("Guild ID"))
        if guild_id == "":
            self.main_menu()
    ...
    def credit(self):
        credits_lines = [
            ...
            "Coder: Bens",
            "Scraper: BensG0ming",
            "Original Owner of BensRaider: BensG0ming",
